  ...
  <div class="manage_page fillcontain">
    <el-row style="height: 100%; min-width:200px">
      ...
      <el-col :span="5"  style="height: 100%; background-color: #324057;overflow-y:scroll;">
        <el-menu theme="dark" style="height: 100%;min-width:230px;" default-active="defaultActive" class="el-menu-vertical-demo">
          ...
          <el-submenu index="2">
            ...
            <el-submenu :index="key1" v-for="(value1,key1,index) in items">
              <template slot="title">{{key1}}</template>

              <el-menu-item :index="ite1" v-for="(ite1, index2) in value1" v-if="ite1!='-'" class="menu-item">
                {{ite1}}
                <div class="add-btn">
      ...
      <el-col :span="19" style="height: 100%;overflow-x: hidden;overflow-y: auto; background-color: #E8E8E8;">
        ...
        <el-row>
          <el-col :span="20">
            <div id="option" style="width:100%;height:600px; margin:40px 0px;"></div>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="20" style="margin-top:60px">
            <div class="el-col el-col-9 el-col-xs-9 el-col-sm-9 el-col-md-9 el-col-lg-9 ">
            <span style="margin-left:50px">持仓量&nbsp;</span>
              <el-input-number v-model="num1" :min="1" :max="9999"></el-input-number>
            </div>
            <el-col :span="4" :offset="2">
              <el-select v-model="value4" clearable placeholder="持仓方向" >
                <el-option
