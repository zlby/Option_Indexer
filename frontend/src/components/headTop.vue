<template>
	<div class = "navigate">
       ...
       <el-col :span="6"  :xs="6" :md="6" :lg="6" :sm="6" v-else>
        <el-menu-item  index="/login"  class="el-col el-col-xs-8 el-col-sm-8 el-col-md-8 el-col-lg-8 main-page-btn"><i class="el-icon-message"></i></el-menu-item>
...
<!--                         <el-form-item>
                        ...
                        <el-form-item>
                            <el-input v-model="form.old_password" id= "old_password" placeholder="Password"></el-input>
                        </el-form-item>
                        <el-form-item>
                            <el-input v-model="form.new_password" id= "new_password" placeholder="newPassword"></el-input>
                        </el-form-item>
                        <el-form-item>
